...
**Hello Rails React** is an exercise to setup RoR + React as one app with Webpack.

## 🗝️ Key Features <a name="key-features"></a>

- Implements `jsbundling-rails`
...
<details>
  ...
  <ul>
    <li><a href="https://react.dev">React and redux</a></li>
  </ul>
</details>
...
```sh
  cd my-folder
  git clone git@github.com:iqbal-elham/hello-rails-react.git
```
...
- Portfolio: [Iqbal-Elham](https://iqbal-elham.onrender.com)
